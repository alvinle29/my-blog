  ...
  <>
    ...
    {position === 'LEFT' && (
      <div className="absolute arrow-btn bottom-5 py-3 cursor-pointer bg-pink-600 left-4 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-7 text-white" fill="none" viewBox="-4 0 24 24" stroke="currentColor">
    ...
    {position === 'RIGHT' && (
      <div className="absolute arrow-btn bottom-5 py-3 cursor-pointer bg-pink-600 right-4 rounded-full">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-10 text-white w-full" fill="none" viewBox="-4 0 24 24" stroke="currentColor">
