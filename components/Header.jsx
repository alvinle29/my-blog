      ...
      <div className="border-b w-full inline-block border-blue-400 py-8">
        ...
        <div className="hidden md:float-left md:contents">
          ...
          <Menu as='div' className='relative md:float-right'>
            <Menu.Button className="md:float-right mt-2 align-middle text-white ml-4 font-semibold cursor-pointer">
              Blogs
            ...
            >
              <Menu.Items className='md:float-right origin-top-right absolute right-0 mt-9 w-52 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none'>
