  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-0 lg:p-8 mb-8">
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <p className="transition duration-500 transform hover:-translate-y-1 inline-block bg-pink-500 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">
            Continue Reading
          </p>
        </Link>
      </div>
